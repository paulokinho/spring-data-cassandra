...
public class CassandraCqlClusterParserUnitTests {
	...
	public void parseInternalCallsDoParseAndConstructsBeanDefinition() {
		...
		assertThat(getPropertyValueAsString(beanDefinition, "clusterBuilderConfigurer")).isEqualTo("testClusterBuilderConfigurer");
		...
		assertThat(getPropertyValueAsString(beanDefinition, "speculativeExecutionPolicy")).isEqualTo("testSpeculativeExecutionPolicy");
	...
	public void parseChildElementsWithLocalPoolingOptions() {
		...
		assertThat(getPropertyValueAsString(poolingOptionsBeanDefinition, "initializationExecutor")).isEqualTo("testExecutor");
