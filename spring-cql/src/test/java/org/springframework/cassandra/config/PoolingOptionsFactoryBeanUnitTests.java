...
public class PoolingOptionsFactoryBeanUnitTests {
	...
	public void configureLocalHostDistancePoolingOptionsCallsConfigureWithExpectedInstance() {
		...
		assertThat(poolingOptionsFactoryBean.configureLocalHostDistancePoolingOptions(poolingOptionsSpy)).isSameAs(poolingOptionsSpy);
	...
	public void configureRemoteHostDistancePoolingOptionsCallsConfigureWithExpectedInstance() {
		...
		assertThat(poolingOptionsFactoryBean.configureRemoteHostDistancePoolingOptions(poolingOptionsSpy)).isSameAs(poolingOptionsSpy);
