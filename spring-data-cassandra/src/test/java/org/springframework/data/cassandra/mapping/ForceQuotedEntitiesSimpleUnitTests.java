...
public class ForceQuotedEntitiesSimpleUnitTests {
	...
	public void testImplicitTableNameForceQuoted() {
		...
		assertThat(entity.getTableName().toCql()).isEqualTo("\"" + ImplicitTableNameForceQuoted.class.getSimpleName() + "\"");
	...
	public void testDefaultTableNameForceQuoted() {
		...
		assertThat(entity.getTableName().toCql()).isEqualTo(DefaultTableNameForceQuoted.class.getSimpleName().toLowerCase());
		assertThat(entity.getTableName().getUnquoted()).isEqualTo(DefaultTableNameForceQuoted.class.getSimpleName().toLowerCase());
	}
